        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <a href="<?php echo e(asset('/')); ?>"><img src="../admin_asset/images/home/logo.png" 
                ...
                <div class="col-sm-8" style="margin-top: 30px">
                    <div  class="pull-right">
                        ...
                        <div class="search_box pull-right">
                            ...
                            <li><a class="linkmenu" href="<?php echo e(asset('/checkout')); ?>"><i class="fa fa-crosshairs"></i> Thanh Toán</a></li>
                            <li><a class="linkmenu" href="<?php echo e(asset('/cart')); ?>"><i class="fa fa-shopping-cart"></i> Giỏ Hàng (<?php echo e(Cart::count()); ?>)</a></li>
                            <?php if(Auth::user()): ?>
                            <li><a  class="linkmenu" href="#"><i class="fa fa-user"></i> <?php echo e(Auth::user()->name); ?></a></li>
...
<?php /**PATH E:\xampp\htdocs\xshop\resources\views/widget/dropdown.blade.php ENDPATH**/ ?>